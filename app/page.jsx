    ...
    <div className="min-h-screen bg-background">
      ...
      <section id="how-it-works" className="container mx-auto px-4 py-16 md:py-24">
        <div className="max-w-5xl mx-auto space-y-12">
          <div className="text-center space-y-4">
            <h2 className="text-3xl md:text-4xl font-bold text-balance">How ReliefConnect Works</h2>
      ...
      <section className="container mx-auto px-4 py-16 md:py-24">
        <div className="max-w-6xl mx-auto space-y-12">
          <div className="text-center space-y-4">
            <h2 className="text-3xl md:text-4xl font-bold text-balance">Active Donation Requests</h2>
            <p className="text-lg text-muted-foreground text-balance max-w-2xl mx-auto">
              See the latest requests from people in need. Your donation can directly support these causes.
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            ...
            <Card className="overflow-hidden hover:shadow-lg transition-shadow">
              <div className="relative h-40 bg-gradient-to-br from-red-400 to-red-600 flex items-center justify-center">
                ...
                <div className="absolute top-3 right-3">
                  <span className="inline-flex items-center px-3 py-1 rounded-full text-xs font-medium bg-red-100 dark:bg-red-950/30 text-red-700 dark:text-red-400">
                    Urgent
                  </span>
                </div>
              </div>
              <CardHeader className="space-y-2">
                <CardTitle className="line-clamp-2">Medicine for Earthquake Victims</CardTitle>
                <CardDescription className="line-clamp-2">
                  Urgent need for antibiotics and medical supplies
                </CardDescription>
              </CardHeader>
              <CardContent className="space-y-4">
                ...
                <Button asChild className="w-full" size="sm">
                  <Link href="/donation-requests">View & Donate</Link>
                </Button>
              </CardContent>
            </Card>
            ...
            <Card className="overflow-hidden hover:shadow-lg transition-shadow">
              <div className="relative h-40 bg-gradient-to-br from-orange-400 to-orange-600 flex items-center justify-center">
                <Package className="h-16 w-16 text-white opacity-20" />
                <div className="absolute top-3 right-3">
                  <span className="inline-flex items-center px-3 py-1 rounded-full text-xs font-medium bg-orange-100 dark:bg-orange-950/30 text-orange-700 dark:text-orange-400">
                    High
                  </span>
                </div>
              </div>
              <CardHeader className="space-y-2">
                <CardTitle className="line-clamp-2">Food and Water Supply</CardTitle>
                <CardDescription className="line-clamp-2">
            ...
            <Card className="overflow-hidden hover:shadow-lg transition-shadow">
              <div className="relative h-40 bg-gradient-to-br from-blue-400 to-blue-600 flex items-center justify-center">
                <Users className="h-16 w-16 text-white opacity-20" />
                <div className="absolute top-3 right-3">
                  <span className="inline-flex items-center px-3 py-1 rounded-full text-xs font-medium bg-orange-100 dark:bg-orange-950/30 text-orange-700 dark:text-orange-400">
                    High
                  </span>
              ...
              <CardHeader className="space-y-2">
                <CardTitle className="line-clamp-2">Shelter Materials</CardTitle>
                <CardDescription className="line-clamp-2">
                  Tents and temporary shelter for displaced persons
                </CardDescription>
              </CardHeader>
              <CardContent className="space-y-4">
                <div className="flex items-center text-sm text-muted-foreground">
                ...
                <div className="space-y-2">
                  ...
                  <div className="w-full bg-muted rounded-full h-2">
                    <div className="bg-primary h-2 rounded-full w-[39%]" />
                  </div>
                  <div className="flex items-center justify-between text-xs text-muted-foreground">
                    <span>$5,800</span>
                    <span>of $15,000</span>
          ...
          <div className="flex justify-center pt-6">
            <Button asChild size="lg" className="w-full sm:w-auto">
              <Link href="/donation-requests">See All Requests</Link>
            </Button>
          </div>
        </div>
      </section>
      ...
      <footer className="border-t border-border bg-card/50 py-12">
        <div className="container mx-auto px-4">
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
            <div className="space-y-4">
              <div className="flex items-center gap-2">
                ...
                <span className="font-bold text-foreground">ReliefConnect</span>
              </div>
              <p className="text-sm text-muted-foreground leading-relaxed">
          ...
          <div className="mt-12 pt-8 border-t border-border text-center text-sm text-muted-foreground">
            <p>&copy; 2025 ReliefConnect. All rights reserved.</p>
          </div>
        </div>
      </footer>
    </div>
